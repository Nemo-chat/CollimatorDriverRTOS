...
SET_MOVEMENT_PARAMETERS_e = 0x0
SET_REFERENCE_POSITION_e = 0x1
SET_MOVEMENT_STATE_e = 0x2
RESET_ERROR_FLAGS_e = 0x3
GET_MOVEMENT_PARAMETERS_e = 0x4
GET_MECHANICAL_DATA_e = 0x5
GET_ELECTRICAL_DATA_e = 0x6
GET_MAXIMUM_POSITION_e = 0x7
GET_FOC_STATE_e = 0x8
GET_SERVICE_MODE_e = 0x9
