...
void PWM_Init(void)
{
    ...
    *((boolean*)&s_PWM_Initialized_b) = True_b;
    ...
    EPwm1Regs.DBFED.all = 1000;
    EPwm1Regs.DBRED.all = 1000;

    EPwm1Regs.CMPA.bit.CMPA             = PWM_DEFAULT_CMP_dU16; /* Setting compare > period - pin is low after initialization. */
   
    /* ePWM 2 setup */
    EPwm2Regs.TBCTL.bit.SWFSYNC         = (U16)1;               /* Sync the timer clock. */
    ...
    EPwm2Regs.DBFED.all = 1000;
    EPwm2Regs.DBRED.all = 1000;

    EPwm2Regs.CMPA.bit.CMPA             = PWM_DEFAULT_CMP_dU16; /* Setting compare > period - pin is low after initialization. */
    ...
    EPwm3Regs.DBFED.all = 1000;
    EPwm3Regs.DBRED.all = 1000;
