...
{
    AC_CMD_NONE_e = 0xFF,
    AC_CMD_GET_MOVEMENT_PARAMS_e = 0,
    AC_CMD_SET_MOVEMENT_PARAMS_e = 1,
    AC_CMD_SET_REFERENCE_POSITION_e = 2,
    AC_CMD_GET_MECHANICAL_DATA_e = 3,
    AC_CMD_GET_ELECTRICAL_DATA_e = 4,
    AC_CMD_GET_MAXIMUM_POSITION_e = 5,
    AC_CMD_RESET_ERROR_FLAGS_e = 6,
    AC_CMD_SET_MOVEMENT_ENABLE_STATE_e = 7
